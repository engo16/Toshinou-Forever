class GlobalSettings {
	...
	get circleNpcturn() {
		return this._settings.circleNpcturn;
	}
	...
	get npcListalpha() {
		return this._settings.npcListalpha;
	}
	get npcListbeta() {
		return this._settings.npcListbeta;
	}
	get npcListgamma() {
		return this._settings.npcListgamma;
	}
	get npcListkappa() {
		return this._settings.npcListkappa;
	}
	get npcListzeta() {
		return this._settings.npcListzeta;
	}
